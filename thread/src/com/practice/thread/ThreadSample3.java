...
public class ThreadSample3 {
    class Runner implements Callable<Integer> {
        ...
        public Integer call() throws Exception {
            ...
            for (int i = 1; i <= 10; i++) {
                Thread.sleep(1000);
                result = i * speed;
                System.out.println("第" + i + "秒: " + this.name +
    ...
    public void start() throws ExecutionException, InterruptedException {
        ...
        System.out.println(threadA.name + "累計跑了" + r1.get() + "米");
        System.out.println(threadB.name + "累計跑了" + r2.get() + "米");
        System.out.println(threadC.name + "累計跑了" + r3.get() + "米");
    }
